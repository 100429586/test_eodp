...
class ismConfig:
    ...
    def __init__(self):
        ...
        #--------------------------------------------------------------------------------
        # CCD
        self.pix_size = 30e-6#42e-6 #30e-6                    # [m] Pixel size in microns for the MS channels
        self.t_int = 0.00672#0.0428 #0.00672                     # [s] Integration time

        # Optical system
        self.D = 0.150#0.07565 #0.150                           # [m] Telescope pupil diameter
        self.f = 0.5262#0.2345 #0.5262                          # [m] Focal length
        ...
        self.apply_prnu = True#False #True
        self.apply_dark_signal = True#False #True
        self.apply_bad_dead = True#False #True
